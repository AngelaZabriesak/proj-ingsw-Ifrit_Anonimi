...
public class CommonGoal6 extends Cgoal{
    ...
    public boolean CommonGoal6(Shelf CShelf) {
        ...
        if ((myshelf[0][0].getColor() == myshelf[1][1].getColor() && myshelf[0][0].getColor() == myshelf[2][2].getColor() && myshelf[0][0].getColor() == myshelf[3][3].getColor() && myshelf[0][0].getColor() == myshelf[4][4].getColor()) ||
